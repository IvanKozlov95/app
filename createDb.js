...
function createUsers(cb) {
	var users = [
		...
		new mongoose.models.Company({login: 'company2', password: '123', name: 'Столовая ИГЭУ', email: 'company@company.com', phone: '123-456-789', address: 'Schorsa st., 68', description: 'One advanced diverted domestic sex repeated bringing you old. Possible procured her trifling laughter thoughts property she met way. Companions shy had solicitude favourable own. Which could saw guest man now heard but. Lasted my coming uneasy marked so should. Gravity letters it amongst herself dearest an windows by. Wooded ladies she basket season age her uneasy saw. Discourse unwilling am no described dejection incommode no listening of. Before nature his parish boy.'}),	
		new mongoose.models.Company({login: 'companyy', password: '123', name: 'Company', email: 'company@company.com', phone: '123-456-789', address: 'Schorsa st., 68', description: 'One advanced diverted domestic sex repeated bringing you old. Possible procured her trifling laughter thoughts property she met way. Companions shy had solicitude favourable own. Which could saw guest man now heard but. Lasted my coming uneasy marked so should. Gravity letters it amongst herself dearest an windows by. Wooded ladies she basket season age her uneasy saw. Discourse unwilling am no described dejection incommode no listening of. Before nature his parish boy.'})
	];
...
function createRequests(cb) {
	var list = [
		...
		{ client: 'Vasya', company: 'companyy', date: new Date(2016,4,29), time: '20:00' },
		...
		// принятые
		{ client: 'Ivan', company: 'company1', date: new Date(2016,5,1), time: '02:44', status: statuses.accepted },
		{ client: 'Ivan', company: 'company2', date: new Date(2016,5,1), time: '03:30', status: statuses.accepted },
		{ client: 'Ivan', company: 'company2', date: new Date(2016,4,31), time: '02:45', status: statuses.accepted },
		{ client: 'user1', company: 'company1', date: new Date(2016,4,31), time: '03:00', status: statuses.accepted },
		{ client: 'Ivan', company: 'companyy', date: new Date(2016,4,31), time: '23:00', status: statuses.accepted }, 
