...
function createRequests(cb) {
	var list = [
		...
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '22:00', status: statuses.accepted },
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted },
		{ client: 'user1', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted },
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted }, 
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted }, 
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted }, 
		{ client: 'Ivan', company: 'company1', date: new Date(2016,4,30), time: '23:00', status: statuses.accepted },
